          ...
          children: [
            ...
            _SectionCard(
              ...
              children: [
                ...
                _FeatureItem(icon: Icons.chat, title: l10n.sekerAiName, description: l10n.sekerAiSubtitle, isDark: isDark),
                ...
                _FeatureItem(icon: Icons.translate, title: l10n.translation, description: l10n.translationDesc, isDark: isDark),
                _FeatureItem(icon: Icons.folder_outlined, title: l10n.medicalRecordsTitle, description: l10n.medicalRecordsDesc, isDark: isDark),
                _FeatureItem(icon: Icons.monitor_heart, title: l10n.vitalsTrackingTitle, description: l10n.vitalsTrackingDesc, isDark: isDark),
                _FeatureItem(icon: Icons.medication, title: l10n.medicationRemindersTitle, description: l10n.medicationRemindersDesc, isDark: isDark),
                _FeatureItem(icon: Icons.event, title: l10n.appointmentManagerTitle, description: l10n.appointmentManagerDesc, isDark: isDark),
                _FeatureItem(icon: Icons.offline_bolt, title: l10n.offlineModeTitle, description: l10n.offlineModeDesc, isDark: isDark),
                _FeatureItem(icon: Icons.language, title: l10n.languagesTitle, description: l10n.languagesDesc, isDark: isDark),
              ],
            ),
