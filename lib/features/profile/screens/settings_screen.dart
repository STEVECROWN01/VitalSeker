    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _SecurityInfoRow(icon: Icons.lock, label: l10n.securityAes256, value: l10n.securityActive, isDark: isDark),
            const SizedBox(height: 12),
            _SecurityInfoRow(icon: Icons.storage, label: l10n.securityLocalStorage, value: l10n.securityHiveEncrypted, isDark: isDark),
            const SizedBox(height: 12),
            _SecurityInfoRow(icon: Icons.cloud_outlined, label: l10n.securityCloudStorage, value: l10n.securitySupabaseRls, isDark: isDark),
            const SizedBox(height: 12),
            _SecurityInfoRow(icon: Icons.token, label: l10n.securityJwtAuth, value: l10n.securityActive, isDark: isDark),
            const SizedBox(height: 12),
            _SecurityInfoRow(icon: Icons.update, label: l10n.securityDataRetention, value: l10n.security24Months, isDark: isDark),
            const SizedBox(height: 16),
            Text(
