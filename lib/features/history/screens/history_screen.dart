  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        // Always scrollable so pull-to-refresh works even on empty state.
        // Previously the empty state was a non-scrollable Center widget,
        // which broke RefreshIndicator.
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (triageResult != null) ...[
                              ...
                              const SizedBox(height: 12),
                              // Tap to view the full triage result screen.
                              Align(
                                alignment: Alignment.centerRight,
                                child: TextButton.icon(
                                  onPressed: () {
                                    // Pass the stored triage result map to the
                                    // TriageResultScreen via go_router's `extra`.
                                    context.push(
