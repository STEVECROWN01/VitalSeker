    ...
    try {
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          build: (context) => [
            ...
            pw.Paragraph(
              text: pdfData['footer']?['producer'] ?? 'Powered by Keter Marketing',
              style: const pw.TextStyle(fontSize: 8, color: PdfColors.grey500),
            ),
          ],
        ),
      ...
      if (mounted) {
        await Share.shareXFiles(
          ...
          text: 'My VitalSeker Health Passport - Generated by Keter Marketing',
        );
      }
    } catch (e) {
      if (mounted) {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'PDF includes Keter Marketing credit as producer',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 12,
